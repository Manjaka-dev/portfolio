                ...
                <Card className="hover-lift">
                  <CardContent className="p-6">
                    ...
                    <div className="flex space-x-4">
                      <Link href="https://www.linkedin.com/in/andrivola-manjaka-andriantsoa-086204290" target="_blank" rel="noopener noreferrer">
                      ...
                      <Link href="https://github.com/Manjaka-dev" target="_blank" rel="noopener noreferrer">
                        <Button variant="outline" size="icon" className="smooth-transition">
                          <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                            <path
                              fillRule="evenodd"
